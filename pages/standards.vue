...
import { ref } from 'vue'
import { Trophy, Users, Dumbbell, ExternalLink, FileText } from 'lucide-vue-next'

useHead({
  title: 'Standards | Monstar Games',
  meta: [
    { name: 'description', content: 'Standards e categorias do Monstar Games 2025/26. Cargas de trabalho, habilidades exigidas e pré-requisitos para cada categoria.' },
    { property: 'og:title', content: 'Standards | Monstar Games' },
    { property: 'og:description', content: 'Standards e categorias do Monstar Games 2025/26' }
  ]
})

const activeTab = ref<'individual' | 'teams'>('individual')
...
<template>
  <div class="bg-black min-h-screen">
    <!-- Hero Section -->
    <div class="relative bg-gradient-to-br from-gray-900 via-black to-gray-900 py-20 overflow-hidden">
      ...
      <div class="relative max-w-7xl mx-auto px-4 text-center">
        <div class="inline-block bg-yellow-500/20 border border-yellow-500 rounded-full px-6 py-2 mb-6">
          <span class="text-yellow-400 font-bold text-sm">TEMPORADA 2025/26</span>
        </div>
        ...
        <div class="mt-8 inline-flex items-center gap-2 text-yellow-400 text-sm">
          <FileText :size="18" />
    ...
    <!-- Tabs -->
    <div class="bg-gray-900 border-b border-gray-800 sticky top-20 z-40">
      <div class="max-w-7xl mx-auto px-4">
        <div class="flex gap-4">
          <button
            @click="activeTab = 'individual'"
            :class="[
              'flex items-center gap-2 px-6 py-4 font-bold transition-all border-b-4',
    ...
    <div class="max-w-7xl mx-auto px-4 py-16">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div
          v-for="(category, idx) in activeTab === 'individual' ? individualCategories : teamCategories"
          :key="idx"
          class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl overflow-hidden border border-gray-700 hover:border-yellow-500 transition-all hover:shadow-xl hover:shadow-yellow-500/20"
        >
          <!-- Header -->
          <div :class="['bg-gradient-to-r', category.color, 'p-6 text-white']">
            <div class="flex items-center gap-3 mb-2">
              <span class="text-4xl">{{ category.icon }}</span>
              <h3 class="text-3xl font-black">{{ category.name }}</h3>
            </div>
          ...
          <div class="p-6 space-y-6">
            ...
            <div v-if="category.weights">
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="bg-gray-800/50 rounded-lg p-4">
                  <div class="text-sm text-gray-400 mb-1">Snatch</div>
                ...
                <div class="bg-gray-800/50 rounded-lg p-4">
                  <div class="text-sm text-gray-400 mb-1">Clean & Jerk</div>
                  <div class="text-white font-bold">
            ...
            <div>
              ...
              <div class="bg-gray-800/50 rounded-lg p-4 text-sm text-gray-300 leading-relaxed">
                <template v-if="typeof category.skills === 'string'">
                  <p>{{ category.skills }}</p>
                </template>
                <template v-else>
                  <p class="mb-3">
                    <strong class="text-white">Masculino:</strong> {{ category.skills.male }}
                  </p>
                  <p>
                    <strong class="text-white">Feminino:</strong> {{ category.skills.female }}
                  </p>
                </template>
              </div>
            </div>
            ...
            <!-- Note -->
            <div v-if="category.note" class="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            ...
            <!-- Footer Note -->
            <div v-if="category.weights" class="text-xs text-gray-500 italic border-t border-gray-700 pt-4">
    ...
    <!-- CTA Section -->
    <div class="bg-gradient-to-r from-cyan-600 to-blue-700 py-16 px-4">
      <div class="max-w-4xl mx-auto text-center text-white">
        <h2 class="text-4xl font-black mb-4">PRONTO PARA COMPETIR?</h2>
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            class="bg-white text-blue-700 px-8 py-4 rounded-lg font-bold text-lg hover:bg-opacity-90 transition flex items-center justify-center gap-2"
          >
            INSCREVER-SE AGORA
          ...
          <NuxtLink
            to="/pre-requisitos"
            class="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white hover:text-blue-700 transition"
          >
            VER PRÉ-REQUISITOS
          </NuxtLink>
        </div>
